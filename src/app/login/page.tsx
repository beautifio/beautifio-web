      ...
      <div className="flex-1 flex flex-col justify-center max-w-[430px] mx-auto w-full px-6">
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center">
            <span className="bg-bg px-3 text-xs text-text-secondary/30">atau</span>
          </div>
        </div>

        <button
          onClick={handleGoogleLogin}
          className="w-full h-12 rounded-xl bg-surface shadow-sm text-sm font-semibold text-text-primary cursor-pointer hover:shadow-md transition-shadow flex items-center justify-center gap-2.5 border-0"
        >
