  ...
  return (
    <div className="bg-surface rounded-[24px] shadow-card relative overflow-hidden">
      ...
      <div className="relative z-10 px-6 py-8">
        ...
        <h1 className="text-[22px] font-bold text-text-primary font-heading mb-1">Selamat datang kembali</h1>
        <p className="text-sm text-text-secondary/50 mb-6">Masuk untuk melanjutkan perjalananmu.</p>
        ...
        <form onSubmit={handleLogin} className="space-y-3.5">
          ...
          <div className="flex justify-end">
            <Link href="/forgot-password" className="text-[11px] text-primary/60 font-medium hover:text-primary transition-colors">Lupa password?</Link>
          </div>
          <button type="submit" disabled={loading}
            className="w-full h-12 rounded-lg bg-primary text-primary-foreground text-sm font-bold cursor-pointer hover:opacity-90 transition-all disabled:opacity-40 shadow-lg shadow-primary/20 flex items-center justify-center gap-2">
        ...
        <button onClick={handleGoogleLogin}
          className="w-full h-12 rounded-lg bg-surface border border-border text-sm font-semibold text-text-primary cursor-pointer hover:bg-muted transition-colors flex items-center justify-center gap-2.5">
